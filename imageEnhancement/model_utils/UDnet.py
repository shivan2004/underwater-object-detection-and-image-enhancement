...
from imageEnhancement.model_utils.utils import  ResBlock, ConvBlock, Up, Compute_z
from imageEnhancement.model_utils.colournet import USLN
...
# Simple Opt class to mimic argparse.Namespace
class Opt:
    def __init__(self, device="cpu"):
        self.device = device
        # you can add more default attributes here if UDnet expects them
        self.threads = 4
        self.gpu_mode = True
        self.testBatchSize = 1
        self.input_dir = "./"
        self.output = "./"
        self.reference_out = "output"
        self.model = "model/UDnet.pth"